...
//插入新图书
function insertBook($isbn, $title, $author, $catid, $price, $description) {
...
//更新图书信息
function updateBook($oldisbn, $isbn, $title, $author, $catid,
    $price, $description) {
...
function displayCategoryForm($category = '') {
...
function displayPasswordForm() {
   ...
   <tr><td>Old password:</td>
       <td><input type="password" name="oldPasswd" size="16" maxlength="16" /></td>
   </tr>
   <tr><td>New password:</td>
       <td><input type="password" name="newPasswd" size="16" maxlength="16" /></td>
   </tr>
   <tr><td>Repeat new password:</td>
       <td><input type="password" name="newPasswd2" size="16" maxlength="16" /></td>
   </tr>
